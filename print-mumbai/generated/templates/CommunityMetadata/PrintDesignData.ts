...
export class PrintDesignData__setCollectionInput_collectionDataStruct extends ethereum.Tuple {
...
export class PrintDesignData__setNFTInput_tokenDataStruct extends ethereum.Tuple {
  get uri(): string {
...
export class PrintDesignData extends ethereum.SmartContract {
  static bind(address: Address): PrintDesignData {
    return new PrintDesignData("PrintDesignData", address);
  }
  ...
  getCollectionPrintType(_collectionId: BigInt): i32 {
    let result = super.call(
      "getCollectionPrintType",
      "getCollectionPrintType(uint256):(uint8)",
      [ethereum.Value.fromUnsignedBigInt(_collectionId)]
    );
  ...
  try_getCollectionPrintType(_collectionId: BigInt): ethereum.CallResult<i32> {
    let result = super.tryCall(
      "getCollectionPrintType",
      "getCollectionPrintType(uint256):(uint8)",
      [ethereum.Value.fromUnsignedBigInt(_collectionId)]
  ...
  setCollection(
    _collectionData: PrintDesignData__setCollectionInput_collectionDataStruct
  ): BigInt {
    let result = super.call(
      "setCollection",
  ...
  setNFT(_tokenData: PrintDesignData__setNFTInput_tokenDataStruct): BigInt {
    let result = super.call(
      "setNFT",
      "setNFT((string,address,uint256,uint256,uint256)):(uint256)",
      [ethereum.Value.fromTuple(_tokenData)]
    );
  ...
  try_setNFT(
    _tokenData: PrintDesignData__setNFTInput_tokenDataStruct
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "setNFT",
      "setNFT((string,address,uint256,uint256,uint256)):(uint256)",
