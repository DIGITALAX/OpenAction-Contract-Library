...
export class PrintOrderData extends ethereum.SmartContract {
  static bind(address: Address): PrintOrderData {
    return new PrintOrderData("PrintOrderData", address);
  }
  ...
  try_printDesignData(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "printDesignData",
      "printDesignData():(address)",
      []
...
export class ConstructorCall__Inputs {
  ...
  get _printDesignDataAddress(): Address {
...
export class SetPrintDesignDataAddressCall extends ethereum.Call {
  get inputs(): SetPrintDesignDataAddressCall__Inputs {
    return new SetPrintDesignDataAddressCall__Inputs(this);
  }

  get outputs(): SetPrintDesignDataAddressCall__Outputs {
    return new SetPrintDesignDataAddressCall__Outputs(this);
  }
}

export class SetPrintDesignDataAddressCall__Inputs {
  _call: SetPrintDesignDataAddressCall;

  constructor(call: SetPrintDesignDataAddressCall) {
    this._call = call;
  }

  get _newPrintDesignDataAddress(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetPrintDesignDataAddressCall__Outputs {
  _call: SetPrintDesignDataAddressCall;
